...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # flag for using Double DQN
        self.use_double_dqn = False
    
    def enable_double_DQN(self):
        """Toggle the use of Double DQN optimization
        """
    ...
    def learn(self, experiences, gamma):
        ...
        if not self.use_double_dqn:
            ...
            # ============= With Double DQN Improvement =================
            # Try using the local Q-network to get expected actions with max predicted Q values
